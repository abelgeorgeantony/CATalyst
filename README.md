...
If trying to add a previous year question paper officially provided by CUSAT, you first need to convert the pdf into a suitable form/structure for the application to use, refer [the JSON schema](./assets/data/db_schema.json). You should also take a look at the already [formatted data](./assets/data/json/).\
